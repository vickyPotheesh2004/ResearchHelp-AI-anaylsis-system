...
from src.config import DEFAULT_LLM_MODEL, TOPIC_MAX_TOKENS, TOPIC_TEMPERATURE, TOPIC_TEXT_CHUNK_SIZE
    ...
    def generate_label(self, text_chunk):
        ...
        try:
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[{"role": "user", "content": f"Label this text with a 3-word title: {text_chunk[:TOPIC_TEXT_CHUNK_SIZE]}"}],
